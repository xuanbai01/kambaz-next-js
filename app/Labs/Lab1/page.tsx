        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li> Prep the Steak </li>
                    <li> Heat the Pan </li>
                    <li> Sear the Steak </li>
                    <li> Flavor and Finish </li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <label htmlFor="wd-radio-fantasy">Fantasy</label>s
            ...
            Please 
            <a href="https://github.com/xuanbai01/kambaz-next-js.git" id="wd-github"> click</a>
